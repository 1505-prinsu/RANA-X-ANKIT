...
OWNER_ID = 6201066540 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [6201066540]

# ✅ Multiple AUTH CHANNELS allowed
AUTH_CHANNELS = [-1003182485007]  # Add more channel IDs here
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("𝐂𝐎𝐍𝐓𝐀𝐂𝐓 📥" ,url=f"https://t.me/Rana_jii_27_bot") ],
                    [
                    InlineKeyboardButton("𝐂𝐇𝐀𝐍𝐄𝐋 ❤️" ,url="https://t.me/OWNER_0044") ],
                    [
                    InlineKeyboardButton("🦋𝐑𝐀𝐍𝐀 𝐉𝐈𝐈 📨🦋" ,url="https://t.me/SUPER_X_RNA")                              
                ],           
            ]
      )
...
async def upload(bot: Client, m: Message):
    ...
    await editable.edit("𝗡𝗼𝘄 𝗦𝗲𝗻𝗱 𝗧𝗵𝗲 𝗧𝗵𝘂𝗺𝗯 𝗨𝗿𝗹 𝗘𝗴 » RANA JII \n\n𝗢𝗿 𝗜𝗳 𝗗𝗼𝗻'𝘁 𝗪𝗮𝗻𝘁 𝗧𝗵𝘂𝗺𝗯𝗻𝗮𝗶𝗹 𝗦𝗲𝗻𝗱 = 𝗻𝗼")
